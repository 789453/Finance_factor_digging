...
class Expression(metaclass=ABCMeta):
    ...
    @property
    def ts_depth(self) -> int: return 0
...
class UnaryOperator(Operator):
    ...
    @property
    def ts_depth(self) -> int: return self._operand.ts_depth
...
class BinaryOperator(Operator):
    ...
    @property
    def ts_depth(self) -> int: return max(self._lhs.ts_depth, self._rhs.ts_depth)
...
class RollingOperator(Operator):
    ...
    @property
    def ts_depth(self) -> int: return self._operand.ts_depth + 1
...
class PairRollingOperator(Operator):
    ...
    @property
    def ts_depth(self) -> int: return max(self._lhs.ts_depth, self._rhs.ts_depth) + 1
